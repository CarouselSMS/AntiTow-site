...
<?php $sandbox_comment_alt = 0 ?>
				...
				<div id="comments-list" class="comments">
					<div id="comments-headline">
					<h2 class="comments-headline"><?php printf($comment_count > 1 ? __('%d Comments', 'sandbox') : __('One Comment', 'sandbox'), $comment_count) ?></h2>
                     </div>
					<ol>
...
<?php if ( 'open' == $post->comment_status ) : ?>
				<div id="respond">
				    <div id="comments-headline">
					<h2 class="comments-headline"><?php _e('POST A COMMENT', 'sandbox') ?></h2>
					</div>
...
<?php else : ?>
							...
							<div class="form-label"><label for="email"><?php _e('E-Mail', 'sandbox') ?></label> <?php if ($req) _e('<span class="required">*</span>', 'sandbox') ?></div>
...
<?php endif /* if ( $user_ID ) */ ?>
							...
							<div class="form-submit"><input name="submit" type="image" style="width: 74px; height:40px;padding:12px 0;" src="<?php bloginfo('template_url'); ?>/images/speak.png" id="submit" tabindex="5" value="Submit Comment" />
